...
export const CLIENTE_SCREEN_MAP: ClienteScreenMeta[] = [
  ...
  { route: '/legal/termos', sourceFile: 'cliente/pages/legal/termos.vue', layout: 'patient', middleware: ['patient-only'] },
  { route: '/legal/privacidade', sourceFile: 'cliente/pages/legal/privacidade.vue', layout: 'patient', middleware: ['patient-only'] },
